...
module.exports = {
  ...
  run: async (client, message, args, { GuildDB }) => {
    ...
    let Embed = new MessageEmbed()
      ...
      .setFooter(
        `Для получения инфы о команде ${
          GuildDB ? GuildDB.prefix : client.botconfig.DefaultPrefix
        }help [команда] | Удачной ёбли!`
      ).setDescription(`${Commands.join("\n")}
  
  FreeLands Music Bot Version: v${require("../package.json").version}
  [✨ Support Server](${
    client.botconfig.SupportServer
  }) | [GitHub](https://github.com/SudhanPlayz/Discord-MusicBot) | [Панель Управления](${client.botconfig.Website}) | By [пендос](https://github.com/SudhanPlayz)`);
