...
class DiscordMusicBot extends Client {
    ...
    this.Manager = new Manager({
      ...
      .on("trackStart", async (player, track) => {
        ...
        let TrackStartedEmbed = new MessageEmbed()
          ...
          .addField("Добавил", `${track.requester}`, true)
          .addField(
            "Длительность",
      ...
      .on("qeueEnd", (player) => {
        let QueueEmbed = new MessageEmbed()
          .setAuthor("Очередь Окончена", this.botconfig.IconURL)
          .setColor(this.botconfig.EmbedColor)
          .setTimestamp();
  ...
  sendError(Channel, Error) {
    let embed = new MessageEmbed()
      .setTitle("<:Wink:801047340642992188> Пшел Отсюда <:otsosi:752510755454320770>")
      .setColor("RED")
      .setDescription(Error)
      .setFooter(
        "У тебя должна быть роль <@&762727208900755456> или админка чтоб мы могли разговаривать как пацан с пацаном!"
      );
